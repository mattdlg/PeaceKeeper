...
class GenerationDialog(QtWidgets.QDialog):
    ...
    def __init__(self, image_folder, parent=None):
        ...
        self.main_layout = QtWidgets.QVBoxLayout(self)
        self.main_layout.setContentsMargins(0, 0, 0, 0) #new
    ...
    def display_new_randoms_images(self):
        ...
        Le layout est mis à jour avec 4 images organisées en format 2x2.
        ...
        image_paths = random.sample(remaining_images, min(4, len(remaining_images)))

        for i, img_path in enumerate(image_paths):
            self.visualized_images.add(img_path)

        self.display_buttons(self.random_img_grid_layout, image_paths, 2)
    ...
    def validate_selection(self):
        ...
        self.main_layout.addStretch(1)
        self.main_layout.addLayout(self.random_img_section_layout)
        self.main_layout.addStretch(1)
        self.main_layout.addLayout(self.button_layout)
